...
<template>
  <section class="w-full py-12 md:py-24 relative overflow-hidden">
    <!-- Background element -->
    <div class="absolute inset-x-0 inset-y-0 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-neutral-900 border border-indigo-500/20 rounded-[2rem] -z-10 shadow-2xl shadow-indigo-500/10 overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-8 py-12 sm:py-16 md:py-24 flex flex-col items-center text-center space-y-6 sm:space-y-8 z-10 relative">
